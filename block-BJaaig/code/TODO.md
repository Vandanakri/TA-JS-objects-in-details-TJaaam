...
console.log(user.sayHello.call(user2, 'Hey')); // output Hello Arya
console.log(user.sayHello.apply(user2, ['Hey'])); // output 
...
console.log(user3.sayHello()); // output / user3 is not a function
